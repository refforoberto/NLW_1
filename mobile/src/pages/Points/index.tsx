...
const Points = () => {
    ...
    useEffect(() => {
      ...
      async function loadPosition(){
        ...
        if(status !== 'granted') {
          Alert.alert("Opsss..", "Precisamos de sua permissão para obter a loclaização");
          navigation.goBack();
          return;
        }
    ...
    return (
        <>
            <View style={ styles.container}>
                <TouchableOpacity>
                    <Icon name='arrow-left' size = { 20 }  color = '#34cb79' onPress={ handleNagigateBack }/>
                </TouchableOpacity>           
